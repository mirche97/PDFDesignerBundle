...
class DesignerTemplateVariablesPass implements CompilerPassInterface
{
    const SERVICE_KEY = 'shopline.designertemplate.variable_provider';
    const TAG         = 'shopline.designertemplate.variable_provider';
