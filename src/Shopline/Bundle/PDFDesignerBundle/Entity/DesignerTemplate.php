...
class DesignerTemplate extends AbstractQueryDesigner implements Translatable , GridQueryDesignerInterface
{
     ...
     * Add translations
     *
     * @param \Shopline\Bundle\PDFDesignerBundle\Entity\DesignerTemplateTranslation $translations
     * @return DesignerTemplate
     */
    public function addTranslation(\Shopline\Bundle\PDFDesignerBundle\Entity\DesignerTemplateTranslation $translations)
    {
        $this->translations[] = $translations;
     ...
     * @param \Shopline\Bundle\PDFDesignerBundle\Entity\DesignerTemplateTranslation $translations
     */
    public function removeTranslation(\Shopline\Bundle\PDFDesignerBundle\Entity\DesignerTemplateTranslation $translations)
    {
